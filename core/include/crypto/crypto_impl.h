...
const struct crypto_ecc_keypair_ops* crypto_asym_get_ecc_keypair_ops(uint32_t
								 key_type);

const struct crypto_ecc_public_ops* crypto_asym_get_ecc_public_ops(uint32_t
								   key_type);
...
static const struct crypto_ecc_public_ops*
